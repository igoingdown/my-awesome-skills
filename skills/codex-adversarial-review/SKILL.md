...
description: 用外部 CodeX CLI 对文档（spec/设计方案/分析报告/runbook）、代码/PR、或两者一起做对抗式独立评审。当用户说"发给 CodeX review""对抗式评审""找 CodeX 挑刺""第二意见""spec/代码评审""开工前/合入前把关"，或要求"把这个告警/问题分析清楚给一份完整报告"时调用。
---
