...
echo ""
echo "Next steps:"
echo "1. Add your Volcengine AK/SK to ~/github/my_dot_files/secrets.sh:"
echo "   export VOLC_ACCESS_KEY=... / export VOLC_SECRET_KEY=...   (see $SCRIPT_DIR/secrets.example.sh)"
